...
def simulate_attack_scenario_2():
    ...
    attack_threads = []
    for i in range(3, 7):  # 4つの攻撃ノードを設定
        attack_thread = threading.Thread(target=attack_node_behavior, args=(nodes[i],))
...
if __name__ == "__main__":
    print("Simulating attack scenario 2:")
    simulate_attack_scenario_2()